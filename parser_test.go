...
var expectedTags = []Tag{
	...
	tag("NewStruct", "24", "r", F{"access": "public", "signature": "()", "ctype": "Struct", "type": "*Struct"}),
	tag("myInt", "28", "t", F{"access": "private", "type": "int"}),
	tag("F1", "30", "m", F{"access": "public", "signature": "()", "ctype": "myInt", "type": "[]bool, [2]*string"}),
	tag("Struct", "34", "e", F{"access": "public", "ctype": "TestEmbed", "type": "Struct"}),
	tag("*io.Writer", "35", "e", F{"access": "public", "ctype": "TestEmbed", "type": "*io.Writer"}),
	tag("TestEmbed", "33", "t", F{"access": "public", "type": "struct"}),
	tag("InterfaceMethod", "39", "m", F{"access": "public", "signature": "(int)", "ntype": "Interface", "type": "string"}),
	tag("OtherMethod", "40", "m", F{"access": "public", "signature": "()", "ntype": "Interface"}),
	tag("io.Reader", "41", "e", F{"access": "public", "ntype": "Interface"}),
